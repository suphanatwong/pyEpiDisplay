...
Outputs: Dataset object (DataFrame)

Components used: Built-in dataset library
...
Outputs: Statistical summary or frequency distribution

Components used: Summary statistics and visualization tools
...
Inputs: Dataset column

Outputs: Table or chart of single-variable statistics

Components used: Summary and visualization functions
...
Inputs: Two dataset columns

Outputs: Cross-tabulation or bivariate summary table

Components used: Data summarization library
...
Inputs: Categorical variable (and optionally frequency data)

Outputs: Bar chart visualization

Components used: Visualization library
...
Inputs: Curated dataset with continuous variables

Outputs: Regression coefficients, R2, predictions

Components used: Linear modeling functions
...
Inputs: dataset with binary dependent variable

Outputs: Model parameters, odds ratios, 95%CI, predictions

Components used: Logistic regression module
